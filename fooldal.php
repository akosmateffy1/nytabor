...
<body>
    ...
    <script src="js/script.js"></script> 
        ...
        <section class="section2">
          <div class="card">
            <div class="card-body">
              <p class="card-text"><strong>Központi elérhetőségeink</strong></p>
              <a class="" href=""><button><i class='bx bx-mobile-alt'></i></button></a>
              <a href=""><button><i class='bx bxl-gmail' ></i></button></a>
              <a href=""><button><i class='bx bxl-messenger' ></i></button></a>
              <a href=""><button><i class='bx bx-phone' ></i></button></a>
            </div>
          </div>
        </section><br>
    </main>
